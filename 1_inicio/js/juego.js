...
// cargar las preguntas del tema que eligió o por pid
...
// Si hay un pid en la URL, filtramos solo esa pregunta específica
const urlParams = new URLSearchParams(window.location.search);
const pid = urlParams.get("pid");

if (pid) {
    preguntasCategoria = preguntas.filter(p => p.id == pid); // ignora la categoría
}
